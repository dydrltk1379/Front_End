...
<body>
    ...
    num4 : ${num4}, ${applicationScope.num4} <br>
<%--    str + num1 : ${str + num1}  <br> 문자열 + 숫자 결합하면 에러 발생--%>
    ...
    <c:out value="<b> b태그 입니다. 굵은 글씨 변환 </b>" escapeXml="true"/> <br><br>

    3.2 HTML 노출하는 방법 <br>
     -> el로 출력하거나 escapeXml로 false로 설정한다. <br>
    ...
    <!-- null 체크 정석적인 문장 ★★★★★-->
    empty를 권장, 이유 : null 체크와 동시에 length가 0인 것도 같이 체크한다. <br>
