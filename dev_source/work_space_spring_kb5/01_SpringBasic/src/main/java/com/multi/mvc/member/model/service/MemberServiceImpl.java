...
// @Service : 서비스임을 알리는 어노테이션 Bean 자동으로 생성되는 객체, new 안쓸예정! -> (di + bean)
@Service
public class MemberServiceImpl implements MemberService {

    // 기존 서블릿에서 사용하던 방법, -> 매우 강한 결함, Spring에서는 지향
    ...
    // Spring 5.3버전부터 아직도 강한 결함이라서 ※Field injection is not recommended 라고함

    // @Autowired // 대신에 Lombok @Setter 사용
