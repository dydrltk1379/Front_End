...
//            System.out.println("문자열을 입력해 주세요. \n");
            ...
            osw.flush(); // buffer를 밀어주는 코드, 관레적 -> 지능적으로 활용, 매우 중요

            char[] buf = new char[1024]; // buffer의 크기는 2의 제곱 값으로 정한다. 512, 1024
            int size = isr.read(buf); // read 멈춰있다.
            // read : blocking 함수, 프로그램의 동작을 멈추고, 특정 이벤트가 발생하면 다시 프로그램 호출하는 함수
